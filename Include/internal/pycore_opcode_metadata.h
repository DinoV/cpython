...
const struct opcode_metadata _PyOpcode_opcode_metadata[267] = {
    ...
    [CALL_METHOD_DESCRIPTOR_3] = { true, INSTR_FMT_IBC00, HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [CALL_METHOD_DESCRIPTOR_3] = { .nuops = 2, .uops = { { _CALL_METHOD_DESCRIPTOR_3, OPARG_SIMPLE, 3 }, { _CHECK_PERIODIC, OPARG_SIMPLE, 3 } } },
...
const char *_PyOpcode_OpName[267] = {
    ...
    [CALL_METHOD_DESCRIPTOR_3] = "CALL_METHOD_DESCRIPTOR_3",
